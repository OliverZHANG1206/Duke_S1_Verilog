...
module processor(
	...
	// Wire define
	wire [31:0] next_pc, curr_pc, pc_p1, pc_p1n; // Current PC and next PC, PC plus one and PC plus n + 1
	...
	assign reg_data = Setx ? ExN27 : Jal ? pc_p1 : Rwd ? deme_data : (Ovfctrl[1] ? (Ovfctrl[0] ? 32'd3 : 32'd2) : (Ovfctrl[0] ? 32'd1 : ALU_result));
